...
<template>
  <nav
    ...
    class="md:hidden fixed bottom-0 left-0 right-0 z-40 border-t border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-950/95 backdrop-blur-lg px-2 py-1 flex items-center justify-around select-none"
  >
    <RouterLink
      to="/"
    ...
    <button
      ...
      class="flex flex-col items-center gap-0.5 p-1.5 rounded-xl text-[#5D87FF] font-bold hover:text-[#4570EA] transition-colors cursor-pointer"
    >
      <LogIn class="w-4 h-4" />
