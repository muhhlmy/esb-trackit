...
<template>
  <div class="w-full flex-1 flex flex-col items-center bg-[#F8FAFC] dark:bg-slate-950 text-[#0F172A] dark:text-slate-100 py-6 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
    <div class="max-w-[1200px] mx-auto w-full h-[calc(100vh-7rem)] overflow-hidden flex relative rounded-2xl border border-[#E5EAEF] dark:border-slate-800 bg-white dark:bg-slate-950 shadow-xs">
      ...
      <!-- Main Canvas Area -->
      <main class="flex-1 flex flex-col overflow-hidden bg-white dark:bg-slate-950 transition-colors border-l border-[#E5EAEF] dark:border-slate-800">
